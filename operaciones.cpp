...
int main () {
    ...
    std :: cout << "A continuacion le pediremos que nos ingrese algunos datos. Para empezar ingrese su apellido.\n";
    std :: string ape;
	std :: cin >> ape;
	...
	std :: cout << "El sistema va a evaluar si su edad es igual al primer numero que ingreso: " << c << ".\n";
	std :: cout << "Ahora evaluara si es mayor o igual al segundo numero que ingreso: " << d << ".\n";
    std :: cout << "La suma de los numeros que ingreso es: " << suma << ".\n";
